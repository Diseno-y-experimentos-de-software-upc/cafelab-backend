...
Feature: US10 - Control de Inventario
  ...
  Scenario: Barista autenticado registra una entrada de inventario exitosamente
    ...
    When envia una solicitud para crear una entrada de inventario con lote 1 cantidad 10.0 motivo "barra" notas "Uso para bebidas en barra"
  ...
  Scenario: Barista intenta registrar consumo de un lote que no le pertenece
    ...
    When envia una solicitud para crear una entrada de inventario con lote 99 cantidad 10.0 motivo "barra" notas "Uso para bebidas en barra"
