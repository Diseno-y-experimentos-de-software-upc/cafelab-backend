...
Feature: US10 - Control de Inventario
  ...
  Scenario: Barista autenticado registra una entrada de inventario exitosamente
    ...
    When envía una solicitud para crear una entrada de inventario con lote 1 cantidad 10.0 producto "Espresso"
  ...
  Scenario: Barista intenta registrar consumo de un lote que no le pertenece
    ...
    When envía una solicitud para crear una entrada de inventario con lote 99 cantidad 10.0 producto "Espresso"
