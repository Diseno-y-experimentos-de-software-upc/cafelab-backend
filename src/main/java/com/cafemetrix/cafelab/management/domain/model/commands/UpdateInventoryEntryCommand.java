...
public record UpdateInventoryEntryCommand(
    ...
    public UpdateInventoryEntryCommand {
        if (inventoryEntryId == null || inventoryEntryId <= 0) {
            throw new IllegalArgumentException("InventoryEntryId es requerido y debe ser positivo");
        }
    ...
    public UpdateInventoryEntryCommand(
            ...
            LocalDateTime dateUsed,
            String finalProduct) {
        this(inventoryEntryId, coffeeLotId, quantityUsed, dateUsed, finalProduct, "other", null);
    }
